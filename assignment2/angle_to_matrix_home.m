...
params = str2double(defaultans); % don't need prompt, only want home coordinate systems for Assignment 2
...
% s = plot3(x,y,z);
% s.Marker = '*';
% title('Joint Origins');               % Don't need 3D plot for Assignment 2
% xlabel('i');
% ylabel('j');
% zlabel('k');
...
% disp('T:');                           % Don't need to print results for assignment 2
% disp(T);
% disp('J:');
% disp(J);
